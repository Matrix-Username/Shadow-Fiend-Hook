...
Java_com_skiy_sf_xposed_XposedBridge_isHooked0(JNIEnv *env, jclass, jobject method) {
    return lsplant::IsHooked(env, method);
}

extern "C"
JNIEXPORT jobject JNICALL
Java_com_skiy_sf_xposed_XposedBridge_hook0(JNIEnv *env, jclass, jobject context,
                                               jobject original,
                                               jobject callback) {
...
extern "C"
JNIEXPORT jboolean JNICALL
Java_com_skiy_sf_xposed_XposedBridge_unhook0(JNIEnv *env, jclass, jobject target) {
    return lsplant::UnHook(env, target);
}

extern "C"
JNIEXPORT jboolean JNICALL
Java_com_skiy_sf_xposed_XposedBridge_deoptimize0(JNIEnv *env, jclass, jobject method) {
    return lsplant::Deoptimize(env, method);
}

extern "C"
JNIEXPORT jboolean JNICALL
Java_com_skiy_sf_xposed_XposedBridge_makeClassInheritable0(JNIEnv *env, jclass, jclass clazz) {
    return lsplant::MakeClassInheritable(env, clazz);
}

extern "C"
JNIEXPORT jboolean JNICALL
Java_com_skiy_sf_xposed_XposedBridge_disableProfileSaver(JNIEnv *, jclass) {
    return disable_profile_saver();
}

extern "C"
JNIEXPORT jboolean JNICALL
Java_com_skiy_sf_xposed_XposedBridge_disableHiddenApiRestrictions(JNIEnv *env, jclass) {
    return disable_hidden_api(env);
}

extern "C"
JNIEXPORT jobject JNICALL
Java_com_skiy_sf_xposed_XposedBridge_allocateInstance0(JNIEnv *env, jclass, jclass clazz) {
    return env->AllocObject(clazz);
}

extern "C"
JNIEXPORT jboolean JNICALL
Java_com_skiy_sf_xposed_XposedBridge_invokeConstructor0(JNIEnv *env, jclass, jobject instance, jobject constructor, jobjectArray args) {
